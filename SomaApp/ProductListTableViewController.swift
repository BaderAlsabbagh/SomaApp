...
class ProductListTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        brandLabel1.text = "Louis Vuitton"
        timeLabel1.text = "01:22:05"
        nameLabel1.text = "Hey My Name is Bag"
